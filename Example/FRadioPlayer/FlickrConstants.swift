...
class FlickrConstants: NSObject {
    ...
    static let api_key = "d22e5c3e492984638d76072b6d5b1c2c"
    static let per_page = 100
    static let searchURL = "https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=d22e5c3e492984638d76072b6d5b1c2c&user_id=188522128%40N06&safe_search=1&per_page=100&format=json&nojsoncallback=1"
    
    
    
    /*static let searchURL = "https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=\(FlickrConstants.api_key)&format=json&nojsoncallback=1&safe_search=1&per_page=\(FlickrConstants.per_page)&text=%@&page=%ld"*/
    
    
    
    
    
    static let imageURL = "https://farm%d.staticflickr.com/%@/%@_%@_\(FlickrConstants.size.url_q.value).jpg"
